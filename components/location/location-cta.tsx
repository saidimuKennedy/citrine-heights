...
export function LocationCTA({ cta, projectSlug }: LocationCTAProps) {
  return (
    <section className="bg-[#111111] px-6 py-28 md:px-16 md:py-40">
      <div className="mx-auto max-w-4xl text-center">
        <MotionReveal y={28}>
          <h2 className="mb-12 font-serif text-4xl font-light capitalize leading-tight text-[#F8F6F2] md:text-6xl lg:text-7xl">
            {cta.headline}
          </h2>
